    ...
    <div>
      ...
      <div className="relative flex justify-between items-center max-w-[500px] w-full m-auto pt-4 text-white z-10">
        <form  onSubmit={feathWeather} className="flex justify-between items-center w-full m-auto bg-transparent border-gray-300 text-white rounded-3xl">
          <div>
            <input onChange={(e)=>setCity(e.target.value)} className="w-full bg-transparent text-white focus:outline-none text-xl mt-5 mx-8 border px-2 py-3 rounded-1xl text-yellow" type="text" placeholder="Enter City"></input>
          </div>
