...
function Weather({ data }) {
  ...
  if (!data || !data.weather || !data.weather[0]) {
    return (<div>
      <br />
      <p className="text-center text-xl text-yellow-400">Loading weather...</p>
    </div>);
      
  }

  return (
    <div className='relative flex flex-col justify-between max-w-[500px] h-[90vh] m-auto p-6 text-yellow-300'>
      {/* Top Section */}
      ...
      <div className='bg-black/40 relative mt-60 p-6 rounded-xl border border-gray-700 shadow-md hover:scale-105 transition-transform'>
        ...
        <div className='flex justify-between text-center text-yellow'>
